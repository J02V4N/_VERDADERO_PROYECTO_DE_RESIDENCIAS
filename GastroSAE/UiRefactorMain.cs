...
namespace GastroSAE
{
    ...
    public static class UiRefactorMain
    {
        ...
        private static void RefactorCobro(TabPage tab)
        {
            ...
            var txtCodigoPostalCfdi = Find<TextBox>(tab, "txtCodigoPostalCfdi");
            var cboRegFiscalCfdi = Find<ComboBox>(tab, "cboRegFiscalCfdi");
            var lblMesaCobroSelector = Find<Label>(tab, "lblMesaCobroSelector");
            var cboMesaCobroSelector = Find<ComboBox>(tab, "cboMesaCobroSelector");
            ...
            if (btnCobroCancelar == null || btnCobroConfirmar == null || lblCobroCambio == null ||
                ...
                lblCobroTotal == null || lblCobroMesa == null ||
            ...
            Label MakeFieldLabel(string name, string textLabel)
            {
                return new Label
                {
                    Name = name,
            ...
            tlPago.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            tlPago.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            tlPago.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            tlPago.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            tlPago.RowStyles.Add(new RowStyle(SizeType.Percent, 100));
            tlPago.RowStyles.Add(new RowStyle(SizeType.AutoSize));

            var lblFormaPago = MakeFieldLabel("lblFormaPagoCobro", "Forma de pago");
            var lblMetodoPago = MakeFieldLabel("lblMetodoPagoCobro", "Método de pago");

            lblResumenCobro.AutoSize = true;
            lblResumenCobro.Margin = new Padding(0, 0, 0, 10);

            cboFormaPago.Dock = DockStyle.Top;
            cboFormaPago.Margin = new Padding(0, 0, 0, 4);

            cboMetodoPago.Dock = DockStyle.Top;
            cboMetodoPago.Margin = new Padding(0, 0, 0, 4);

            var gbCaptura = new GroupBox
            {
                Text = "Captura de cobro",
                Dock = DockStyle.Top,
                Padding = new Padding(12),
                AutoSize = true
            };

            var tlCaptura = new TableLayoutPanel
            {
                Dock = DockStyle.Top,
                ColumnCount = 1,
                RowCount = 8,
            ...
            for (int i = 0; i < 8; i++) tlCaptura.RowStyles.Add(new RowStyle(SizeType.AutoSize));

            var lblRecibido = MakeFieldLabel("lblRecibidoCobro", "Recibido");
            var lblReferencia = MakeFieldLabel("lblReferenciaCobro", "Referencia");
            var lblModoInfo = MakeFieldLabel("lblModoCobroInfo", "En efectivo se calcula el cambio automáticamente.");
            lblModoInfo.ForeColor = Color.DimGray;
            lblModoInfo.Margin = new Padding(0, 0, 0, 10);

            txtImporteRecibido.Dock = DockStyle.Top;
            txtImporteRecibido.Margin = new Padding(0, 0, 0, 8);
            ...
            if (btnReimprimir != null) btnReimprimir.Visible = false;

            lblCambio.AutoSize = true;
            lblCambio.Margin = new Padding(0, 0, 0, 8);

            tlCaptura.Controls.Add(lblModoInfo, 0, 0);
            tlCaptura.Controls.Add(lblRecibido, 0, 1);
            tlCaptura.Controls.Add(txtImporteRecibido, 0, 2);
            tlCaptura.Controls.Add(lblReferencia, 0, 3);
            tlCaptura.Controls.Add(txtCobroRef, 0, 4);
            tlCaptura.Controls.Add(lblCambio, 0, 5);

            gbCaptura.Controls.Add(tlCaptura);

            tlPago.Controls.Add(lblResumenCobro, 0, 0);
            tlPago.Controls.Add(lblFormaPago, 0, 1);
            tlPago.Controls.Add(cboFormaPago, 0, 2);
            tlPago.Controls.Add(lblMetodoPago, 0, 3);
            tlPago.Controls.Add(cboMetodoPago, 0, 4);
            tlPago.Controls.Add(gbCaptura, 0, 5);
            ...
            for (int i = 0; i < 8; i++) tlCfdi.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            ...
            var lblCodigoPostal = txtCodigoPostalCfdi != null ? MakeFieldLabel("lblCodigoPostalCfdiRuntime", "Código postal") : null;
            var lblRegimenFiscal = cboRegFiscalCfdi != null ? MakeFieldLabel("lblRegFiscalCfdiRuntime", "Régimen fiscal") : null;

            if (txtCodigoPostalCfdi != null)
            {
                txtCodigoPostalCfdi.Dock = DockStyle.Top;
                txtCodigoPostalCfdi.Margin = new Padding(0, 0, 0, 10);
            }
            if (cboRegFiscalCfdi != null)
            {
                cboRegFiscalCfdi.Dock = DockStyle.Top;
                cboRegFiscalCfdi.Margin = new Padding(0, 0, 0, 10);
            }
            ...
            int row = 3;
            if (lblCodigoPostal != null && txtCodigoPostalCfdi != null)
            {
                tlCfdi.Controls.Add(lblCodigoPostal, 0, row++);
                tlCfdi.Controls.Add(txtCodigoPostalCfdi, 0, row++);
            }
            if (lblRegimenFiscal != null && cboRegFiscalCfdi != null)
            {
                tlCfdi.Controls.Add(lblRegimenFiscal, 0, row++);
                tlCfdi.Controls.Add(cboRegFiscalCfdi, 0, row++);
            }
            tlCfdi.Controls.Add(cboUsoCFDI, 0, row++);
            tlCfdi.Controls.Add(new Panel { Dock = DockStyle.Fill }, 0, row);
            ...
            actions.Controls.Add(btnConfirmarCobro, 3, 0);
                ...
                private static void RefactorInventario(TabPage tab)
        {
            ...
            try
            {
                ...
                chkInvSimularBascula.Visible = FeatureFlags.BasculaVisible;
                ...
                {
                    // Reutilizar las columnas cuando la báscula está oculta.
                    // La columna 0 deja de ser del checkbox y pasa a alojar la captura manual.
                    tlCap.ColumnStyles[0].Width = 140;
                    tlCap.ColumnStyles[0].SizeType = SizeType.Absolute;
                    tlCap.ColumnStyles[1].Width = 90;
                    tlCap.ColumnStyles[1].SizeType = SizeType.Absolute;
                    tlCap.ColumnStyles[2].Width = 160;
                    tlCap.ColumnStyles[2].SizeType = SizeType.Absolute;
                    tlCap.ColumnStyles[3].SizeType = SizeType.AutoSize;
                }

                tlCap.Controls.Add(txtInvPesoGr, colPeso, 0);
                tlCap.Controls.Add(lblInvKg, colPeso + 1, 0);
                tlCap.Controls.Add(txtInvCostoKg, colPeso + 2, 0);
                tlCap.Controls.Add(btnInvAgregar, colPeso + 3, 0);
...
private static void RefactorConfig(TabPage tab)
        {
            ...
            var txtNombreNegocio = Find<TextBox>(tab, "txtNombreNegocio");
            var lblNombreNegocio = Find<Label>(tab, "lblNombreNegocio");
            var cboTicketAncho = Find<ComboBox>(tab, "cboTicketAncho");
            var lblTicketAncho = Find<Label>(tab, "lblTicketAncho");
            var cboTicketReprintNv = Find<ComboBox>(tab, "cboTicketReprintNv");
            var lblTicketReprintNv = Find<Label>(tab, "lblTicketReprintNv");
            var btnTicketReprintNv = Find<Button>(tab, "btnTicketReprintNv");
            ...
            if (btnCfgRecetas == null || btnCfgIngredientes == null || btnCfgMeseros == null || btnCfgMesas == null || btnGuardarConfig == null ||
                ...
                txtNombreNegocio == null || lblNombreNegocio == null || cboTicketAncho == null || lblTicketAncho == null ||
                cboTicketReprintNv == null || lblTicketReprintNv == null || btnTicketReprintNv == null)
                return;
            ...
            for (int i = 0; i < 5; i++) stack.RowStyles.Add(new RowStyle(SizeType.AutoSize));
            ...
            tlConn.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 170));
            ...
            txtNombreNegocio.Dock = DockStyle.Top;
            ...
            lblNombreNegocio.Margin = new Padding(0, 2, 0, 4);
            txtNombreNegocio.Margin = new Padding(0, 0, 0, 0);
            ...
            tlConn.Controls.Add(lblNombreNegocio, 0, 2);
            tlConn.SetColumnSpan(lblNombreNegocio, 2);
            tlConn.Controls.Add(txtNombreNegocio, 0, 3);
            tlConn.SetColumnSpan(txtNombreNegocio, 2);
            ...
            var tlDev = new TableLayoutPanel
            {
                Dock = DockStyle.Top,
                ColumnCount = 1,
                RowCount = FeatureFlags.BasculaVisible ? 3 : 1,
                AutoSize = true,
                BackColor = Color.Transparent
            };
            cboImpresora.Dock = DockStyle.Top;
            cboImpresora.Margin = new Padding(0, 0, 0, FeatureFlags.BasculaVisible ? 10 : 0);
            ...
            if (FeatureFlags.BasculaVisible)
            {
                ...
                btnProbarBascula.Margin = new Padding(0);
            ...
            var tlTicket = new TableLayoutPanel
            {
                Dock = DockStyle.Top,
                ColumnCount = 1,
                RowCount = 5,
            ...
            lblTicketAncho.Margin = new Padding(0, 2, 0, 4);
            cboTicketAncho.Dock = DockStyle.Top;
            cboTicketAncho.Margin = new Padding(0, 0, 0, 10);
            lblTicketReprintNv.Margin = new Padding(0, 2, 0, 4);
            cboTicketReprintNv.Dock = DockStyle.Top;
            cboTicketReprintNv.Margin = new Padding(0, 0, 0, 10);
            btnTicketReprintNv.Dock = DockStyle.Top;
            btnTicketReprintNv.Margin = new Padding(0);
            tlTicket.Controls.Add(lblTicketAncho, 0, 0);
            tlTicket.Controls.Add(cboTicketAncho, 0, 1);
            tlTicket.Controls.Add(lblTicketReprintNv, 0, 2);
            tlTicket.Controls.Add(cboTicketReprintNv, 0, 3);
            tlTicket.Controls.Add(btnTicketReprintNv, 0, 4);
            gbTicket.Controls.Add(tlTicket);
            ...
            const int ADM_BTN_H = 72;
            tlAdm.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50f));
            tlAdm.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50f));
            ...
            var admBtnFont = new System.Drawing.Font(btnCfgMesas.Font.FontFamily, Math.Max(9f, btnCfgMesas.Font.Size - 1.0f), btnCfgMesas.Font.Style);
            foreach (var b in new[] { btnCfgMesas, btnCfgMeseros, btnCfgIngredientes, btnCfgRecetas })
            {
                b.Font = admBtnFont;
                b.MinimumSize = new System.Drawing.Size(0, ADM_BTN_H);
                b.Dock = DockStyle.Fill;
                b.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                b.Margin = new Padding(0, 0, 10, 10);
            }
            btnCfgMeseros.Margin = new Padding(0, 0, 0, 10);
            btnCfgRecetas.Margin = new Padding(0);
            btnCfgIngredientes.Margin = new Padding(0, 0, 10, 0);
            btnCfgMesas.Margin = new Padding(0, 0, 10, 10);
            tlAdm.Controls.Add(btnCfgMesas, 0, 0);
            tlAdm.Controls.Add(btnCfgMeseros, 1, 0);
            tlAdm.Controls.Add(btnCfgIngredientes, 0, 1);
            tlAdm.Controls.Add(btnCfgRecetas, 1, 1);
            gbAdmin.Controls.Add(tlAdm);

            stack.Controls.Add(gbConn, 0, 0);
            stack.Controls.Add(gbDevices, 0, 1);
            stack.Controls.Add(gbTicket, 0, 3);
            stack.Controls.Add(gbAdmin, 0, 4);
            ...
            root.Controls.Add(btnGuardarConfig, 0, 1);
